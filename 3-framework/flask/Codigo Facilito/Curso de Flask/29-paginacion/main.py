...
def create():
    ...
    if request.method== 'POST' and create_form.validate():
        ...
        print ("Error en el formulario de registro")
...
def reviews(page=1):
    ...
    comments = Comment.query.join(User).add_columns(User.username, Comment.text).paginate(page=page, per_page=per_page, error_out=False)
