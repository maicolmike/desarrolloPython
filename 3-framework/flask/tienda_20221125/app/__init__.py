...
from flask_wtf.csrf import CSRFProtect #evitar ataques de formulario
from flask_login import LoginManager, login_user, logout_user, login_required, current_user
#from flask_mail import Mail

from werkzeug.security import generate_password_hash, check_password_hash #prueba encriptado

from .models.ModeloCompra import ModeloCompra
from .models.ModeloLibro import ModeloLibro #from .models.ModeloLibro import ModeloLibro # el primer ModeloLibro es el nombre del archivo el segundo es el nombre de la clase
...
def index():
    if current_user.is_authenticated: # usuario debe estar logeado
        if current_user.tipousuario.id == 1: #si el tipo de usuario es administrador o cliente
            try:
